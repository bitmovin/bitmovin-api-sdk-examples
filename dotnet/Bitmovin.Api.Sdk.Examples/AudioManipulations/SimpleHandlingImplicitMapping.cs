...
{
    /// <summary>
    /// <para> This example demonstrates the simplest mechanism to include a stereo audio stream in an MP4 
    /// output given the input file contains a stereo audio stream (and a video stream), with the use of a
    /// single IngestInputStream.</para>
    ///
    ...
    /// </list>
    /// </summary>
    public class SimpleHandlingImplicitMapping : IExample
    {
