...
namespace Bitmovin.Api.Sdk.Examples
{
    ...
    /// <description>The path to a file containing a video with a single audio stereo stream</description>
    /// </item>
    /// <item>
    ...
    /// </list>
    /// </summary>
    public class ChannelMixingSwappingChannels : IExample
    {
        private ConfigProvider _configProvider;
        private BitmovinApi _bitmovinApi;
        private const string ClassName = "ChannelMixingSwappingChannels";
        ...
        public async Task RunExample(string[] args)
        {
            ...
            var outputChannel0 = new AudioMixInputStreamChannel()
            {
                ...
                SourceChannels = new List<AudioMixInputStreamSourceChannel> {sourceChannel1}
            };
            ...
            var outputChannel1 = new AudioMixInputStreamChannel()
            {
                ...
                SourceChannels = new List<AudioMixInputStreamSourceChannel> {sourceChannel0}
            };

            var audioMixChannels = new List<AudioMixInputStreamChannel>(){outputChannel0, outputChannel1};
