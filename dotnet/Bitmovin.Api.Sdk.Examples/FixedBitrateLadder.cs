...
{
    /// <summary>
    /// This example demonstrates how to create multiple MP4 renditions in a single encoding, using a fixed
    /// resolution- and bitrate ladder.<para />
    ///
    /// <para />
    ...
    /// </list>
    /// </summary>
    public class FixedBitrateLadder : IExample
    {
        ...
        {
            return Path.Join(_configProvider.GetS3OutputBasePath(), nameof(FixedBitrateLadder), relativePath);
        }
