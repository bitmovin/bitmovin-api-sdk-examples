<p align="center">
  <h1 align="center">Bitmovin Java API SDK Examples</h1> 
...
#### Linux
Execute run_example.sh with the name of the desired [example](src/main/java/com/bitmovin/api/sdk/examples) as first parameter, followed by a list of configuration parameters if needed.
```bash
