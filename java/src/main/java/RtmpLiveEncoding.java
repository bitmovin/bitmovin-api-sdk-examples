 ...
 * </ol>
 */
public class RtmpLiveEncoding {

  private static final Logger logger = LoggerFactory.getLogger(RtmpLiveEncoding.class);
  ...
  public static String buildAbsolutePath(String relativePath) {
    String className = RtmpLiveEncoding.class.getSimpleName();
