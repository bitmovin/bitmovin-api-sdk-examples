 ...
 * </ol>
 */
public class StreamMerging_BackgroundAudio {

  private static final Logger logger = LoggerFactory.getLogger(StreamMerging_BackgroundAudio.class);
  ...
  public static void main(String[] args) throws Exception {
    ...
    String inputFilePath = configProvider.getHttpInputFilePathWithTwoStereoTracks();
  ...
  public static String buildAbsolutePath(String relativePath) {
    String className = StreamMerging_BackgroundAudio.class.getSimpleName();
