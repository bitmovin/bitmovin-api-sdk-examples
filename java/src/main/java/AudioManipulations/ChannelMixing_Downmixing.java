 ...
 * </ol>
 */
public class ChannelMixing_Downmixing {

  private static final Logger logger = LoggerFactory.getLogger(ChannelMixing_Downmixing.class);
  ...
  public static void main(String[] args) throws Exception {
    ...
    String inputFilePath = configProvider.getHttpInputFilePathWithSurroundSound();
  ...
  public static String buildAbsolutePath(String relativePath) {
    String className = ChannelMixing_Downmixing.class.getSimpleName();
