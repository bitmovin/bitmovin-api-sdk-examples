 ...
 * </ol>
 */
public class SimpleHandling_DistinctInputFiles {

  private static final Logger logger =
      LoggerFactory.getLogger(SimpleHandling_DistinctInputFiles.class);
  ...
  public static void main(String[] args) throws Exception {
    ...
    String videoInputFilePath = configProvider.getHttpInputFilePath();
    String stereoInputFilePath = configProvider.getHttpInputFilePathWithStereoSound();
    String surroundInputFilePath = configProvider.getHttpInputFilePathWithSurroundSound();
  ...
  public static String buildAbsolutePath(String relativePath) {
    String className = SimpleHandling_DistinctInputFiles.class.getSimpleName();
