 ...
 * </ol>
 */
public class StreamMapping_MonoInputTracks {

  private static final Logger logger = LoggerFactory.getLogger(StreamMapping_MonoInputTracks.class);
  ...
  public static void main(String[] args) throws Exception {
    ...
    String inputFilePath = configProvider.getHttpInputFilePathWithMultipleMonoAudioTracks();
  ...
  public static String buildAbsolutePath(String relativePath) {
    String className = StreamMapping_MonoInputTracks.class.getSimpleName();
