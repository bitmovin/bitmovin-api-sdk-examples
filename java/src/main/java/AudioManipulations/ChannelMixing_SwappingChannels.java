 ...
 * </ol>
 */
public class ChannelMixing_SwappingChannels {

  private static final Logger logger =
      LoggerFactory.getLogger(ChannelMixing_SwappingChannels.class);
  ...
  public static String buildAbsolutePath(String relativePath) {
    String className = ChannelMixing_SwappingChannels.class.getSimpleName();
